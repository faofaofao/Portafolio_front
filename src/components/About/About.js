...
const About = () => {
  ...
  return (
    <section id="about" className="py-16 bg-gradient-to-b from-[#2D3047] to-[#1E2033] text-[#A8AAB8]"> {/* Fondo con tonalidades de #2D3047 */}
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center md:space-x-8">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 text-center md:text-left">
            <p className="leading-relaxed mb-4 text-lg md:text-xl" data-aos="fade-up" style={{ color: '#CACDDB' }}> {/* Texto con color claro */}
            ...
            <p className="leading-relaxed mb-4 text-lg md:text-xl" data-aos="fade-up" data-aos-delay="200" style={{ color: '#A8AAB8' }}> {/* Texto con tonalidad media */}
            ...
            <p className="leading-relaxed mb-4 text-lg md:text-xl" data-aos="fade-up" data-aos-delay="400" style={{ color: '#878A99' }}> {/* Texto con color más oscuro */}
